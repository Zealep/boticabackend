package com.zealep.api.salesbackend.repository.jdbc;

import com.zealep.api.salesbackend.model.dto.ParametersReporteVentasDTO;
import com.zealep.api.salesbackend.model.dto.ReporteDetallesVentasDTO;
import com.zealep.api.salesbackend.model.dto.ReporteMesDTO;
import com.zealep.api.salesbackend.model.dto.ReporteVentasDTO;
...
public class ReporteVentasJdbcRepository {
    ...
    private StringBuilder buildSqlVentas(ParametersReporteVentasDTO params){
        ...
        sql.append("select concat(v.cliente,' - ' ,v.documento) as cliente,concat(e.nombres,' ',e.apellidos) as empleado,v.codigo,v.fecha,v.sub_total,v.descuento,v.igv,v.total from venta v "
    ...
    private StringBuilder buildSqlDetallesVentas(ParametersReporteVentasDTO params){
        StringBuilder sql = new StringBuilder();
        sql.append("select concat(v.cliente,' - ' ,v.documento) as cliente,concat(e.nombres,' ',e.apellidos) as empleado,v.codigo,v.fecha,ca.nombre as categoria,p.nombre as producto,dv.precio,dv.cantidad,dv.total from detalle_venta dv \n" +
    ...
    private static final class ReporteVentasMapper implements RowMapper<ReporteVentasDTO> {
        ...
        public ReporteVentasDTO mapRow(ResultSet rs, int rowNum) throws SQLException {
            ...
            t.setFechaVenta(rs.getDate("fecha").toLocalDate());
